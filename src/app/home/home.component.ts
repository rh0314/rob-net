...
export class HomeComponent implements OnInit {
  ...
  initItems() {
    this.techItems = [
      ...
      { text: "Delightful, Intuitive User Experience", image: { path: "../../assets/images/internet-icons/ux.png", sizeX: 0, sizeY: 0 }, startX: -1500, startY: -500, homeX: 1, homeY: 0, duration: 6000, delay: 2000, backImage: '' },
      ...
      { text: "ASP.NET", image: { path: "../../assets/images/aspnet-logo.png", sizeX: '150px', sizeY: '150px' }, startX: '6000', startY: '4000', homeX: 2, homeY: 0, duration: 3000, delay: 2500, backImage: '' },
      { text: "C#", image: "../../assets/images/internet-icons/c-sharp.png", startX: '650', startY: '-1000', homeX: -3, homeY: 0, duration: 0, delay: 0, backImage: '' },
      { text: "Angular (2+)", image: { path: "../../assets/images/internet-icons/angular2.png", sizeX: '100', sizeY: 'auto' }, startX: 0, startY: 5000, homeX: 0, homeY: 0, duration: 1750, delay: 3000, backImage: '' },
      ...
      { text: "Multiple-OS Proficiency", image: { path: "../../assets/images/internet-icons/multi-os.png", sizeX: '150px', sizeY: '150px' }, startX: '-50000', startY: '-50000', homeX: 3, homeY: 0, duration: 6000, delay: 2500, backImage: '' },
    ];
  }
